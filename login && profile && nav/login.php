...
<head>
    ...
    <!-- links -->
    <link rel="shortcut icon" href="images/SCCI.png" type="image/x-icon">
    ...
    <div class="card">
        ...
        <form method="POST">
            <div class="field">
                ...
                <input autocomplete="off" id="logemail" class="input-field" name="user_email" type="email"
            ...
            <div class="field">
                ...
                <input autocomplete="off" id="logpass" class="input-field" name="user_password" type="password"
            ...
            <!-- Login button -->
            <button class="btn" name="login" type="submit">
